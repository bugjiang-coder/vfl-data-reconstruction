...
if __name__ == '__main__':
    ...
    parser.add_argument('--origin_data_output', default="/home/yangjirui/paper-code/data/adult/2layer-enhance2/bs/origin_data.csv",
                        help='location of the data corpus')
    parser.add_argument('--inverse_data_output', default="/home/yangjirui/paper-code/data/adult/2layer-enhance2/bs/inverse_data.csv",
                        help='location of the data corpus')
    ...
    tab = {
        ...
        'intList': [0],
        'range':[20]+[1 for i in range(1, 51)]
    }
    # 规范化后使用下面的表格初始化
    # tab = {
    #     'boolList':[7, 15],
