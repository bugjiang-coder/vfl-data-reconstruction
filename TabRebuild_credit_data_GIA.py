...
def rebuild(train_data, test_data, tab, device, args):
    ...
    net = vfltrainer.bottom_model_list[1]
    net = net.to(device)
    ...
    for trn_X, trn_y in tqdm(train_queue):
        ...
        originData = trn_X[1]
        protocolData = shadow_net.forward(originData).clone().detach()
...
if __name__ == '__main__':
    ...
    # config file
    parser.add_argument('--c', type=str, default='./configs/attack/credit/data.yml', help='config file')
