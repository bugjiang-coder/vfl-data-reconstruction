...
if __name__ == '__main__':
    ...
    parser.add_argument('--origin_data_output', default="/home/yangjirui/paper-code/data/adult/2layer-noloss/base-random/origin_data.csv",
                        help='location of the data corpus')
    ...
    models = [
        base_path + '2layers_0.pth',
        base_path + '2layers_1.pth']
    # models = [
    #     base_path + '3layers_0.pth',
    #     base_path + '3layers_1.pth']
    # models = [
    #     base_path + '4layers_0.pth',
    #     base_path + '4layers_1.pth']
