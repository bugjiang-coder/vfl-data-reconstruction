...
from fedml_core.model.net import active_model, passive_model_layer5
...
def run_experiment(train_data, test_data, device, args):
    ...
    #                                range(args.k - 1)]
    model_list = [active_party] + [passive_model_layer5(input_dim=Xb_train.shape[1], intern_dim=Xb_train.shape[1]+1, output_dim=Xb_train.shape[1]+2) for _ in
                                   range(args.k - 1)]
    ...
    vfltrainer.save_model('/home/yangjirui/paper-code/model/adult/','5layers')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='adult-5layer', help='experiment name')
