...
def run_experiment(train_data, test_data, device, args):
    ...
    vfltrainer.save_model('/home/yangjirui/paper-code/model/zhongyuan/','2layer_not_normal')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='zhongyuan_2layer_not_normal', help='experiment name')
    ...
    train, test = preprocess_zhongyuan(args.data_dir, False)
