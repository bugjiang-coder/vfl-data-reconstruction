...
from fedml_core.preprocess.criteo.preprocess_criteo import preprocess
from fedml_core.model.net import active_model, passive_model
from fedml_core.utils.vfl_trainer import VFLTrainer
from fedml_core.utils.utils import criteo_dataset
...
def run_experiment(train_data, test_data, device, args):
    ...
    vfltrainer.save_model('/home/yangjirui/paper-code/model/criteo/')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default="/home/yangjirui/feature-infer-workspace/dataset/criteo/",
                        help='location of the data corpus')
    parser.add_argument('--name', type=str, default='vfl_criteo_baseline', help='experiment name')
