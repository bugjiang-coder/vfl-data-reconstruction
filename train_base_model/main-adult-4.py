...
def run_experiment(train_data, test_data, device, args):
    ...
    vfltrainer.save_model('/home/yangjirui/paper-code/model/adult/','4layers-enhance2')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='adult-4layer-enhance2', help='experiment name')
