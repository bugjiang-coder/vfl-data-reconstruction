...
from fedml_core.preprocess.avazu.preprocess_avazu import preprocess_avazu
...
def run_experiment(train_data, test_data, device, args):
    ...
    #torch.save(party_b_model.state_dict(), './model/zhongyuan_party_b_model_stage.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='/home/yangjirui/feature-infer-workspace/dataset/avazu/', help='location of the data corpus')
    parser.add_argument('--name', type=str, default='vfl_baseline', help='experiment name')
    ...
    wandb.init(project="my-fedml-avazu-project", entity="yang-test",
               name="VFL-{}".format(args.name),
               config=args)

    #data_dir = "../../../data/zhongyuan/"
    train, test = preprocess_avazu(args.data_dir)
