...
def run_experiment(device, args, ratio=0.5):
    ...
    print("################################ Load Data ############################")
    train_data, test_data = preprocess(args.data_dir, A_ratio=ratio)
    ...
    vfltrainer.save_model(args.save, 'best.pth.tar' + str(ratio), epoch, auc)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='/home/yangjirui/data/vfl-tab-reconstruction/dataset/credit/clients.xls',
    ...
    args.save = "/data/yangjirui/vfl-tab-reconstruction/model/credit/radio/"
