...
def run_experiment(train_data, test_data, device, args):
    ...
    active_party = active_model(input_dim=Xa_train.shape[1], intern_dim=10, num_classes=1, k=args.k)


    #model_list = [active_party]+ [passive_model_easy(input_dim=Xb_train.shape[1], intern_dim=20, output_dim=10) for _ in range(args.k-1)]
    model_list = [active_party] + [passive_model_easy(input_dim=Xb_train.shape[1], intern_dim=20, output_dim=10) for _ in
                                   range(args.k - 1)]
    ...
    vfltrainer.save_model('/home/yangjirui/paper-code/model/zhongyuan/','not-normalization-2layers-enhance')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default="/home/yangjirui/feature-infer-workspace/dataset/zhongyuan/", help='location of the data corpus')
    parser.add_argument('--name', type=str, default='vfl_not_normalization_baseline', help='experiment name')
    ...
    wandb.init(project="VFL-basemodel", entity="yang-test",
