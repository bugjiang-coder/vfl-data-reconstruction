...
def run_experiment(train_data, test_data, device, args):
    ...
    vfltrainer.save_model('/home/yangjirui/paper-code/model/zhongyuan/',"2layer_normal_enhance")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='2layer_normal_enhance', help='experiment name')
